...
Revision ID: 4ebafd9408dd
Revises: 
Create Date: 2023-08-25 11:01:49.788210
...
def upgrade():
    ...
    sa.Column('comunidad_autonoma', sa.String(length=250), nullable=True),
    sa.Column('provincia', sa.String(length=250), nullable=True),
